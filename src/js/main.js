...
const MENU_DROPDOWN_BTN__EL = document.getElementById('menu-dropdown-button');
const DROPDOWN_MENU__EL = document.getElementById('header-dropdown-menu');
MENU_DROPDOWN_BTN__EL.addEventListener('click', () => {
    MENU_DROPDOWN_BTN__EL.classList.toggle('menu__dropdown-button--rotate')
    DROPDOWN_MENU__EL.classList.toggle('menu__dropdown-links--invisible')
});

const FOOTER_DROPDOWN_BTN__EL = document.querySelector('.footer__dropdown-button');
...
FOOTER_DROPDOWN_BTN__EL.addEventListener('click', () => {
    FOOTER_DROPDOWN_BTN__EL.classList.toggle('footer__dropdown-button--rotate')
